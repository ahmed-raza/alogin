...
class SettingsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['2fa_fieldset']['qr'] = [
      '#type' => 'markup',
      '#markup' => "<img src='". $authenticator->getQr() ."' alt='QR'>"
    ];
    ...
    $form['2fa_fieldset']['validate'] = [
      '#type' => 'button',
      '#value' => t('Verify'),
      '#ajax' => [
        'callback' => '::aloginSettingsCallback'
      ]
    ];
    $form['submit'] = [
      '#type' => 'submit',
  ...
  public function aloginSettingsCallback(array &$form, FormStateInterface $form_state) {
    ...
    if ($form_state->getErrors()) {
      ...
      $response->addCommand(new ReplaceCommand('.settings-form', $form));
      return $response;
    }
    $this->messenger->addMessage($this->t('Code validated!'));
    unset($form['#prefix']);
    unset($form['#suffix']);
    $form['status_messages'] = [
      '#type'   => 'status_messages',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->aloginAuthenticator->store($this->currentId, $enable);
    if ($enable) {
